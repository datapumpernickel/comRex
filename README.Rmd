...
Comext might sometimes not return the data, but tell you that it will be provided asynchroniously, in that case, you need to execute the request again after some time. This still needs to be implemented properly. 
